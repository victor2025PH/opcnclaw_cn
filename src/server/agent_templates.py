...
AGENT_ROLES: Dict[str, AgentRole] = {
    ...
    "writer": _r("writer", "文案", "✍️", "营销文案、产品描述、新闻稿",
                  "你是文案高手。文字生动有感染力，产出要详细充实（至少500字）。可以用web_search搜索资料。", "glm-4-flash",
                  ["web_search"]),
    "editor": _r("editor", "编辑", "📝", "校对润色、排版、标题优化、事实核查",
                  "你是资深编辑。校对润色、标题优化、事实核查。产出要完整详细。可以用web_search验证信息。", "glm-4-flash",
                  ["web_search"]),
    ...
    "copywriter": _r("copywriter", "创意总监", "💡", "创意构思、Campaign方案、资料采集",
                      "你是创意总监。擅长创意构思和资料采集。用web_search搜索最新资料，产出要详细有深度（至少800字）。", "deepseek-chat",
                      ["web_search"]),
    ...
    "data_analyst": _r("data_analyst", "数据分析师", "📈", "数据采集、清洗、可视化、趋势分析",
                        "你是数据分析师。擅长从数据中发现规律。用web_search采集数据，产出要详细有数据支撑。", "deepseek-chat",
