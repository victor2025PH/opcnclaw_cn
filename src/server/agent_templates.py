...
AGENT_ROLES: Dict[str, AgentRole] = {
    ...
    "writer": _r("writer", "文案", "✍️", "营销文案、产品描述、新闻稿",
                  "你是文案高手。文字生动有感染力，风格多变。适配不同平台和受众。如果需要搜索资料，可以使用桌面工具打开浏览器搜索。", "glm-4-flash",
                  ["desktop_hotkey", "desktop_type", "open_application", "desktop_screenshot"]),
    "editor": _r("editor", "编辑", "📝", "校对润色、排版、标题优化、事实核查",
                  "你是资深编辑。擅长校对润色和标题优化。可以使用桌面工具搜索验证信息。", "glm-4-flash",
                  ["desktop_hotkey", "desktop_type", "open_application", "desktop_screenshot"]),
    ...
    "copywriter": _r("copywriter", "创意总监", "💡", "创意构思、Campaign方案、资料采集",
                      "你是创意总监。擅长Big Idea和概念创新。可以用桌面工具搜索灵感和竞品资料。", "deepseek-chat",
                      ["desktop_hotkey", "desktop_type", "open_application", "desktop_screenshot"]),
    ...
    "data_analyst": _r("data_analyst", "数据分析师", "📈", "数据采集、清洗、可视化、趋势分析",
                        "你是数据分析师。擅长从数据中发现规律。可以使用桌面工具搜索和采集数据。", "deepseek-chat",
                        ["calculate", "desktop_hotkey", "desktop_type", "open_application", "desktop_screenshot"]),
