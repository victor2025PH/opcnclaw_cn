...
PROVIDER_CAPABILITIES = {
    ...
    "deepseek":       {"chat": 85, "reasoning": 95, "coding": 95, "writing": 80, "data": 90},
    ...
    "openai":         {"chat": 95, "reasoning": 95, "coding": 95, "writing": 90, "vision": 95, "data": 90},
...
TASK_KEYWORDS = {
    ...
    "coding":    ["代码", "编程", "函数", "bug", "api", "python", "javascript", "html", "css", "sql", "代码", "程序", "debug", "code"],
...
def get_routing_recommendation(configured_providers: List[str]) -> List[Dict]:
    ...
    for task_type, label in task_labels.items():
        best = get_best_provider(task_type, configured_providers)
        if best:
            caps = PROVIDER_CAPABILITIES.get(best, {})
            score = caps.get(task_type, 50)
